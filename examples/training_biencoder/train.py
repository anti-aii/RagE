...
import torch 
import wandb
from rag_chatbot import TrainerBiEncoder, SentABDL, SentABCollate, BiEncoder
...
if __name__ == "__main__": 
    ...
    model= BiEncoder(model_name= config['model_name'], required_grad= config['required_grad'], num_label= config['num_label'])
